package day14.task3;
/*
Cоздать класс “Человек” с полями “имя” и “возраст”. Реализовать статический метод
...
import day14.task2.NumberException;
...
public class Task3 {
    public static void main(String[] args) throws NumberException, FileNotFoundException {
        System.out.println(parseFileToStringList());
    }

    public static List<Person> parseFileToStringList() throws FileNotFoundException, NumberException {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (Integer.parseInt(person[1])<0) {
                    throw new NumberException(" Значение меньше нуля!");
                }

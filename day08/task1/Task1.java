...
public class Task1 {
    public static void main(String[] args) {
        //Программа для работы с клаасом String
        String string = "";
        ...
        System.out.println("Время выполнения цикла с классом String: " + (after - before)); // ~1110 мс


        //Программа для работы с клаасом StringBuilder
        StringBuilder stringBuilder = new StringBuilder("");

        before = System.currentTimeMillis();

        for (int i = 0; i <= 20000; i++) {
            stringBuilder.append(i).append(" "); //Конкатенация с помощью метода append
        }

        after = System.currentTimeMillis();

        System.out.println(stringBuilder);
        System.out.println("Время выполнения цикла с классом StringBuilder: " + (after - before)); // ~1 мс
    }
}
